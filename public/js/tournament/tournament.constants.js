...
export const TOURNAMENT_MESSAGES = Object.freeze({
  ...
  PUBLISHED_AND_ACTIVATED: 'Tournament published and set as active.',
  ...
  CONFIRM_DELETE: 'Delete this tournament permanently? All matches, predictions, and contestant history for this tournament will be removed. This action is irreversible and cannot be undone.',
  ...
  CANNOT_DELETE_NOT_ARCHIVED: 'Archive this tournament before permanently deleting it.',
